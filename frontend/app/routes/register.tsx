      ...
      <>
        {!showMap ? (
          ...
          <div className="space-y-3">
            <Suspense fallback={<div className={`${mapHeight} bg-gray-100 rounded-lg flex items-center justify-center text-gray-400 text-sm border border-dashed border-gray-300`}>Loading map...</div>}>
            ...
            <div className="flex gap-2">
              <button type="button" onClick={handleClearMap} className="flex-1 border border-gray-300 text-gray-600 py-2 rounded-lg text-xs font-medium hover:bg-gray-50 transition-colors">Clear</button>
              <button type="button" onClick={() => setShowMap(false)} className="flex-1 bg-[var(--clr-primary)] text-white py-2 rounded-lg text-xs font-bold hover:bg-[var(--clr-primary-hover)] transition-colors">Confirm Location</button>
            </div>
          </div>
        )}
      </>
    ...
    return (
      <div className="min-h-screen bg-white">
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="em-form-grid">
                  ...
                  <div>
                    ...
                    {egnError ? <p className="text-red-600 font-bold mt-1" style={{ fontSize: "18px" }}>{egnError}</p> : <p className="em-body text-gray-500 mt-1" style={{ fontSize: "16px" }}>10-digit Bulgarian national ID number</p>}
                  </div>
                  <div>
                  ...
                  <div className="em-full-width">
                    <label className="flex items-center gap-3">
                      ...
                      <span className="em-body">I agree to the{" "}<button type="button" onClick={() => setIsTermsModalOpen(true)} className="text-(--clr-primary) hover:text-(--clr-primary-hover) font-bold underline">terms and conditions</button></span>
                    </label>
                  </div>
                  <div className="em-full-width">
                ...
                <p className="em-body mt-6">Already have an account?{" "}<Link to="/login" className="text-(--clr-primary) hover:text-(--clr-primary-hover) font-bold underline">Sign in here</Link></p>
              </>
            )}
          </section>
        </div>
        ...
        <footer className="bg-gray-100 border-t border-gray-200 mt-20 animate-fade-in">
          <div className="max-w-4xl mx-auto px-4 py-8 text-center text-black"><p>&copy; 2025 InReach. Bringing healthcare to remote areas.</p></div>
        </footer>
      </div>
    );
  }
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="animate-slide-in-up [animation-delay:400ms]">
                    ...
                    {egnError ? <p className="text-xs text-red-600 mt-1 font-medium">{egnError}</p> : <p className="text-xs text-gray-500 mt-1">10-digit Bulgarian national ID number</p>}
                  </div>
                  ...
                  <label className="flex items-start animate-slide-in-up [animation-delay:800ms]">
                    ...
                    <span className="ml-2 text-sm text-gray-700">I agree to the{" "}<button type="button" onClick={() => setIsTermsModalOpen(true)} className="text-(--clr-primary) hover:text-(--clr-primary-hover) font-semibold underline transition-all duration-200">terms and conditions</button></span>
                  </label>
                ...
                <p className="text-center text-gray-600 mt-6">Already have an account?{" "}<Link to="/login" className="text-(--clr-primary) hover:text-(--clr-primary-hover) font-bold hover:underline transition-all duration-200">Sign in here</Link></p>
              </>
            )}
          </div>
        </div>
